...
module WatirPageHelper::Plist
 ...
 def click_statistics
   ele = @browser.a(:xpath,"//section[@id='div_statistics']//a[@id='statistics_pencil']")
  ele.wait_until_present
  if ele.exists?
     ele.click
  else
 ...
 def edit_statistics loantype
  sleep 3
     @browser.select_list(:id,"opportunity_loan_type_id").when_present.select loantype
 end   
