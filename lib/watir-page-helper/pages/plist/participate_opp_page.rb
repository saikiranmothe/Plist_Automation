...
def search_id
       ...
       @browser.input(:id, "text_search_query").send_keys $ele_id
  ...
  def click_manage_opp
    @browser.a(:xpath,"//div[3]/table/tbody/tr/td[6]/a[2]").wait_until_present 5
    @browser.a(:xpath,"//div[3]/table/tbody/tr/td[6]/a[2]").click
  end
  ...
  def rec_disbursement 
      ...
      if signoff_text.include? "Yes"
        ...
        @browser.input(:id,"disbursement_confirmation_code").when_present.send_keys "Abcd123121"
        ...
        @browser.div(:xpath,"//div[9]/div/div/div[3]").wait_until_present
        if @browser.div(:xpath,"//div[9]/div/div/div[3]").exists?
           #@browser.a(:id,"ok-btn").click
           @browser.a(:xpath,"//div[9]/div/div/div[3]/a[1]").click
           sleep 5
  ...
  def opp_close?
       ele = @browser.tr(:xpath,"//div[3]/table/tbody/tr[1]")
       ele.wait_until_present 5
       ele.text
    if ele.exists?
      return "#{ele} is displayed"
    else
      raise "#{ele} not found"
    end
  end
