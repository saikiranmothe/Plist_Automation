...
Scenario: Admin Filter the users by Status
    ...
    Then I should able to see all the approved user in the table
    Then I select 'Blocked' status from the option
    Then I should able to see all the blocked user in the table
    Then I select 'Locked' status from the option
    Then I should able to see all the locked user in the table
